//
// Created by Thomas Brooks on 5/27/23.
//

#ifndef CRYPTOH_SHA256_H
#define CRYPTOH_SHA256_H
...
private:
    ...
    static const uint32_t LOG_MAX_MESSAGE_BITS = 64;
    static const uint32_t PAD_LIMIT = BLOCK_SIZE - LOG_MAX_MESSAGE_BITS;
    static const char PAD_BUFFER = '\x80';
    static const char PAD = '\x00';
    constexpr static const uint32_t INITIAL_HASH_STATE[8] = {
            0x6a09e667,
            0xbb67ae85,
            0x3c6ef372,
            0xa54ff53a,
    ...
    constexpr static const uint32_t HASH_CONSTANTS[LOG_MAX_MESSAGE_BITS] = {
...
public:
    ...
    sha256* consume(const std::string& msg);
    void clear_state();
    std::string digest();
};

#endif //CRYPTOH_SHA256_H
